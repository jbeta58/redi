...
export default async function DashboardHomePage() {
  ...
  // Each regular user has exactly one device
  ...
  // Online = polled within last 10 minutes
 ...
 * Keeps the home page informative without being overwhelming.
 */
...
function ConfigSummary({
  ...
  switch (appId) {
    ...
    case 'three_city_clock':
      // Show the three city names if set
